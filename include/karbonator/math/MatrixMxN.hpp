#ifndef KARBONATOR_MATH_MATRIXMXN_HPP
#define KARBONATOR_MATH_MATRIXMXN_HPP

#include "karbonator/def.hpp"
#include "karbonator/pp/env.hpp"
#include "VectorN.hpp"
...
namespace math
{
    ...
    public:
        ...
        template <typename E, SizeType M, SizeType N>
        friend KARBONATOR_PP_DLL_API_TEMPLATE const MatrixMxN<E, M, N> operator +(const MatrixMxN<E, M, N> & lhs, const MatrixMxN<E, M, N> & rhs);
        ...
        template <typename E, SizeType M, SizeType N>
        friend KARBONATOR_PP_DLL_API_TEMPLATE const MatrixMxN<E, M, N> operator *(const MatrixMxN<E, M, N> & matrix, const E & scalar);

        template <typename E, SizeType M, SizeType N>
        friend KARBONATOR_PP_DLL_API_TEMPLATE const MatrixMxN<E, M, N> operator *(const E & scalar, const MatrixMxN<E, M, N> & matrix);

        template <typename E, SizeType L, SizeType M, SizeType N>
        friend KARBONATOR_PP_DLL_API_TEMPLATE const MatrixMxN<E, L, N> operator *(const MatrixMxN<E, L, M> & lhs, const MatrixMxN<E, M, N> & rhs);
